create_df_comoparison <- function(fit_hX, stan_hX) {
...
plot_data_h3vac <- create_df_comoparison(best_fit_h3only, h3only_stan)
plot_data_h1vac <- create_df_comoparison(best_fit_h1only, h1only_stan)
plot_data_h3cell <- create_df_comoparison(best_fit_h3cell, h3cell_stan)
